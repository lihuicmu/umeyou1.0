			...
			$.ajax({
				...
				success: function (data) {
					if (data && data.totals.length) {
						...
						//	html += '<td><span class="extra bold ' + grand_total_points + '">' + data.totals[i].title + '</span></td>';
							//html += '<td><span class="bold ' + grand_total_points + '">' + data.totals[i].text + '</span></td>';
							html += '</tr>';
						}
						$('.cart-info.totals table#totals_table').html(html);
					}
